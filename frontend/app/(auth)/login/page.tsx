      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-[24px] border border-[var(--border)]
          ...
          <p className="text-sm mb-6" style={{ color: "var(--muted)" }}>
            Sign in to your ÉLOITE account
          </p>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative">
                <input type={showPass ? "text" : "password"} value={password}
                  ...
                  required autoComplete="current-password" className={`${input} pr-11`} />
        ...
        <p className="text-center text-sm mt-5" style={{ color: "var(--muted)" }}>
          ...
          <Link href="/signup" className="font-semibold hover:opacity-70 transition-colors"
            style={{ color: "var(--heading)" }}>Create one</Link>
        </p>
      </div>
    </div>
  );
